...
void drawTriangleWithColor(const glm::vec3& v0, const glm::vec3& v1, const glm::vec3& v2, const glm::vec3& color, float transparency);
void drawMesh(const Mesh& mesh);
void drawSphere(const Sphere& sphere);
void drawSphere(const glm::vec3& center, float radius, const glm::vec3& color = glm::vec3(1.0f));
void drawSphereWireFrame(const glm::vec3& center, float radius, const glm::vec3& color = glm::vec3(1.0f));
